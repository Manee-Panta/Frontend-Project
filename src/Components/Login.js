      ...
      if (name && ename && cname === "") {
        ...
        if(getuserArr && getuserArr.length){
          ...
          const userlogin = userdata.filter((el,k)=>{
            return(
              params.name==='Jobseeker' ?el.name ===name && el.password===password :el.ename===ename&&el.cname===cname&& el.password===password
          ...
          if(userlogin.length ===0){
            ...
            params.name==='Jobseeker' ? navigate('/jobseeker'): navigate('/employer')
        ...
        <div className="login-leftData ">
          ...
          <div className="login-rightData ">
            ...
            <Form>
              ...
              {
                params.name==='Employer'? <><Form.Group>
                <Form.Control
                  type="text"
